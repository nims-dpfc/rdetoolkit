...
class InvoiceFile:
    ...
    def overwrite(self, dst_file_path: Path, *, src_file_path: Optional[Path] = ...): ...
...
class RuleBasedReplacer:
    ...
    def get_apply_rules_obj(
        self, replacements: dict[str, Any], source_json_obj: Optional[dict[str, Any]], *, mapping_rules: Optional[dict[str, str]] = ...
    ) -> dict[str, Any]: ...
...
def apply_magic_variable(
    invoice_path: Union[str, Path], rawfile_path: Union[str, Path], *, save_filepath: Optional[Union[str, Path]] = ...
) -> dict[str, Any]: ...
